...
//    maskView.frame = fromVC.view.bounds;
    maskView.frame = CGRectMake(0, 0, kScreenWidth, CGRectGetHeight(fromVC.view.frame)-kStatusH - 0.5);
    ...
    toVC.view.frame = CGRectMake(x, 0, CGRectGetWidth(containerView.frame), CGRectGetHeight(containerView.frame)-kStatusH - 0.5);
...
//    maskView.frame = fromVC.view.bounds;
    ...
    toVC.view.frame = CGRectMake(x, 0, width, CGRectGetHeight(containerView.frame) - kStatusH - 0.5);
