...
@interface DemoZFScanViewController ()<AVCaptureMetadataOutputObjectsDelegate>
...
/** 遮罩层 */
@property (nonatomic, strong) DemoZFMaskView * maskView;
/** 返回按钮 */
...
@implementation DemoZFScanViewController
 ...
 */
- (void)addUI{
    self.maskView = [[DemoZFMaskView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
