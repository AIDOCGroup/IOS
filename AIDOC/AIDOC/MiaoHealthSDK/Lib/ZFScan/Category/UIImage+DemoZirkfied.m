...
#import "UIColor+DemoZirkfied.h"

@implementation UIImage (DemoZirkfied)
...
void DemoProviderReleaseData (void *info, const void *data, size_t size){
    free((void*)data);
}
...
- (UIImage*)imageBlackToTransparent:(UIImage*)image withRed:(CGFloat)red andGreen:(CGFloat)green andBlue:(CGFloat)blue{
    ...
    // 输出图片
    CGDataProviderRef dataProvider = CGDataProviderCreateWithData(NULL, rgbImageBuf, bytesPerRow * imageHeight, DemoProviderReleaseData);
