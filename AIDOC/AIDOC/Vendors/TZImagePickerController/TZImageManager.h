...
/**
 ...
 @param completion  //ios8 放回 PHAssetCollection.localIdentifier
     ios8 以下 TZAlbumModel
 */
...
//获得视频路径
- (void)getVideoURLWithAsset:(id)assert completion:(void (^)(NSURL *fileUrl))completion;
