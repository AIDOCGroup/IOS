...
- (void)makeUI {
    ...
    _containerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 240)];
    _containerView.backgroundColor = [UIColor whiteColor];
    _containerView.layer.cornerRadius = 3;
    _containerView.layer.masksToBounds = YES;
    _datePicker =  [[UIDatePicker alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 240)];
