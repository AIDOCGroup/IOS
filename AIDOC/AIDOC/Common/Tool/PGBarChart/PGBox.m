...
- (NSString *)makeString {
    ...
    if (_title) {
        ...
        if (_unit) {
            finalText = [[NSString stringWithFormat:@"%ld", (long)_value] stringByAppendingString:_unit];
        }
        else {
            finalText = [NSString stringWithFormat:@"%ld", (long)_value];
        }
    }
