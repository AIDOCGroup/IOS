...
- (void)initialize {
    ...
    self.lineWidth = 2;
    UIImage *bgImg = [UIImage gradientColorImageFromColors:@[TOPColor, BOTTOMColor] gradientType:GradientTypeLeftToRight imgSize:CGSizeMake(kScreenWidth, 2)];
    self.strokeColor = [UIColor colorWithPatternImage:bgImg].CGColor;
