...
@property (nonatomic, weak) id<YZSocketDelegate> socketDelegate;
...
/**
 ...
 @param callback 返回未读数
 */
- (void)getMessageUnreadNumber:(void(^)(NSError *error, NSUInteger number))callback;
