...
#import "YZSJSONModelError.h"
#import "YZSJSONValueTransformer.h"
#import "YZSJSONKeyMapper.h"

/////////////////////////////////////////////////////////////////////////////////////////////
#if TARGET_IPHONE_SIMULATOR
#define YZSJMLog( s, ... ) NSLog( @"[%@:%d] %@", [[NSString stringWithUTF8String:__FILE__] \
 ...
 *
 */
@protocol YZSOptional
@end

/**
 * Make all objects compatible to avoid compiler warnings
 */
@interface NSObject (JSONModelPropertyCompatibility) <YZSOptional, YZSIgnore>
@end

/////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark - YZSJSONModel protocol
/**
 * A protocol describing an abstract JSONModel class
 * JSONModel conforms to this protocol, so it can use itself abstractly
 */
@protocol YZSAbstractJSONModelProtocol <NSCopying, NSCoding>
...
/////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark - YZSJSONModel interface
/**
 ...
 */
@interface YZSJSONModel : NSObject <YZSAbstractJSONModelProtocol, NSSecureCoding>
...
+ (void)setGlobalKeyMapper:(YZSJSONKeyMapper *)globalKeyMapper DEPRECATED_MSG_ATTRIBUTE("override +keyMapper in a base model class instead");
 ...
 */
- (instancetype)initWithString:(NSString *)string error:(YZSJSONModelError **)err;
 ...
 * or a property type in your model is not supported by JSONValueTransformer and its categories
 */
- (instancetype)initWithString:(NSString *)string usingEncoding:(NSStringEncoding)encoding error:(YZSJSONModelError **)err;
